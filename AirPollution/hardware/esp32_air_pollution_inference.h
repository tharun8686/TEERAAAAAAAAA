...
static const float AIR_SCALER_MEAN[12] = {
    70.5080f, 145.0920f, 49.7345f, 27.9179f, 58.4805f, 982.0479f, 70.4788f, 70.4510f, 0.0395f, 0.0013f, 0.0008f, -0.0012f
};

static const float AIR_SCALER_STD[12] = {
    64.4167f, 102.8687f, 36.4555f, 3.6983f, 15.4850f, 1.1228f, 64.3379f, 64.2675f, 12.7746f, 0.4258f, 0.7092f, 0.7050f
};
